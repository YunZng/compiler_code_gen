...
alias test4='cd ~/compilers/fall2022-tests/assign04/';
alias test5='cd ~/compilers/fall2022-tests/assign05/';
alias get='back; make clean;
git pull origin main; make clean;
make depend; make -j;';
export ASSIGN04_DIR=~/compilers/assign04-yulun/compiler_code_gen/;
export ASSIGN05_DIR=~/compilers/assign04-yulun/compiler_code_gen/;
