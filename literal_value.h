...
public:
  ...
  LiteralValue from_char_literal(const std::string &lexeme, const Location &loc) const;
  LiteralValue from_int_literal(const std::string &lexeme, const Location &loc) const;
  LiteralValue from_str_literal(const std::string &lexeme, const Location &loc) const;
